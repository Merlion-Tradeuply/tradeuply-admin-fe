    ...
    <main className="px-5 py-8 sm:px-8 lg:px-10 lg:py-10 xl:px-12">
      <div className="mb-8 flex items-start justify-between gap-5">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 font-medium text-[var(--color-muted)]">Review submitted USDT transfers. Approval credits the client balance and creates an immutable ledger entry.</p>
        </div>
